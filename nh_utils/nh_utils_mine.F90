...
! Use cubic spline routine to map w from grid centers (w2 at pm2) to grid edges (we at pem)
 ...
 if (jslice==128 .and. is <= 128 .and. ie >= 128) then
   write(*,*), 'w centers', w2(128,59:60)
   write(*,*), 'wedges', q4(2,128,59:60)
 endif
 do k = 1,km
   do i = is,ie
     we(i,k) = q4(2,i,k)
